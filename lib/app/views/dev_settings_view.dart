...
import 'package:whatsapp_clone/app/views/settings_views/layout_settings_view.dart';
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          ListTile(
            leading: Icon(Icons.layers_outlined, color: theme.iconTheme.color),
            title: const CustomText('Layout Settings',),
            trailing: Icon(Icons.arrow_forward_ios, color: theme.iconTheme.color),
            onTap: () => Get.to(() => const LayoutSettingsView()),
          ),
